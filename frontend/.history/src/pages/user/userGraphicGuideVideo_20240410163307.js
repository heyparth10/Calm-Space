      ...
      <Box>
        <Box>
          <div className="w-[205vh] relative overflow-clip">
            ...
            <img src={greenbg} className="object-cover w-full h-[246vh]" />
        ...
        <div className="w-full absolute top-[244vh] flex justify-center space-x-1">
                ...
                <div className="w-full absolute top-[2446vh] flex justify-center space-x-1">
                <p className="text-xl ">Take</p>
                  <a href="http://localhost:3001/" className="text-xl text-red-600 font-bold hover:text-violet-400 duration-300 ease-in-out"> Live Guidance </a>
                <p className="text-xl ">from Experts</p>
                </div>
