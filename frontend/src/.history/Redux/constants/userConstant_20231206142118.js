...
exportUSER_LOAD_REQUEST = "USER_LOAD_REQUEST";
export const USER_LOAD_SUCCESS = "USER_LOAD_SUCCESS";
export const USER_LOAD_FAIL = "USER_LOAD_FAIL"; const 
...
export const CREATOR_JOB_REQUEST = "CREATOR_JOB_REQUEST";
export const CREATOR_JOB_SUCCESS = "CREATOR_JOB_SUCCESS";
export const CREATOR_JOB_FAIL = "CREATOR_JOB_FAIL";
export const CREATOR_JOB_RESET = "CREATOR_JOB_RESET";
