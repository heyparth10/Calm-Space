    ...
    <>
      <Box>
        ...
        <div className="w-full absolute top-[240vh] flex justify-center space-x-1">
                ...
                <a href="https://buy.stripe.com/test_6oE7vk0sAen25FK144" className="text-xl text-red-600 font-bold hover:text-violet-400 duration-300 ease-in-out">Take Live Guidance from Experts</a>
                </div>
      </Box>
      <Footer />
    </>
