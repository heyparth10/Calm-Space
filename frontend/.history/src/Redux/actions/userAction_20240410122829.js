...
export const userProfileAction = () => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.get(`${backend_api}api/me`, config);
        dispatch({ 
...
export const creatorBlogAction = (blog) => async (dispatch) => {
    ...
    try{
        const { data } = await axios.post(`${backend_api}api/creator/blogcreatorhistory`, blog);
...
export const userApplyBlogAction = (blog) => async (dispatch) => {
    ...
    try{
        const { data } = await axios.post(`${backend_api}api/user/bloghistory`, blog);
        console.log(data);
        dispatch({
...
export const updateVideoProgressAction = (url, isCompleted, userId) => async (dispatch) => {
    ...
    try {
        const { data } = await axios.post(`${backend_api}/api/user/updateVideoProgress`, { url, isCompleted, userId });
        dispatch({ 
