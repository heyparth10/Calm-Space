...
return (
    <>
        <Sidebar className='bg-gradient-to-r z-20 from-gray-700 via-gray-900 to-black' backgroundColor="" style={{ borderRightStyle: "none" }}>
                    ...
                    >
                        {
                            userInfo && userInfo.role === 1 ?
                                <>
                                    ...
                                    <MenuItem component={<Link to="/admin/blogs" />} icon={<WorkIcon />}> Blogs </MenuItem>
                                    <MenuItem component={<Link to="/admin/category" />} icon={<CategoryIcon />}> Category </MenuItem>
                                    <MenuItem component={<Link to="/admin/info" />} icon={<CategoryIcon />}> Admin Profile </MenuItem>
                                </> :
                                 (
                                    userInfo && userInfo.role === 2 ?
                                    <>
                                        <MenuItem component={<Link to="/creator/dashboard" />} icon={<DashboardIcon />}> Dashboard </MenuItem>
                                        <MenuItem component={<Link to="/creator/blogs" />} icon={<WorkIcon />}> Blogs </MenuItem>
                                        {/* <MenuItem component={<Link to="/creator/category" />} icon={<CategoryIcon />}> Category </MenuItem> */}
                                        <MenuItem component={<Link to="/creator/info" />} icon={<CategoryIcon />}> Creator Profile </MenuItem>
                                    </> :
                                    <>
                                        <MenuItem component={<Link to="/user/dashboard" />} icon={<DashboardIcon />}> Dashboard </MenuItem>
                                        <MenuItem component={<Link to="/user/blogs" />} icon={<WorkHistoryIcon />}> Personalized Lessons </MenuItem>
